...
process.env.MQTT_HEIGHT_FORM = `${farmName}/${func[1]}/${nodeName}`;
process.env.MQTT_SHOW_HIEGHT = `${farmName}/${func[2]}/${nodeName}`;
process.env.MQTT_DETECT_STATE = `${farmName}/${func[3]}/${nodeName}`;
process.env.MQTT_HEIGHT_STATE = `${farmName}/${func[4]}/${nodeName}`;
process.env.MQTT_GET_IMAGE = `${farmName}/${func[5]}/${nodeName}`;
process.env.MQTT_GET_DATA = `${farmName}/${func[6]}/${nodeName}`;
process.env.MQTT_AI_STATUS = `${farmName}/${func[7]}/${nodeName}`;
process.env.MQTT_IMAGE = `${farmName}/${func[8]}/${nodeName}`;

// env variable for light control
...
process.env.MQTT_MH = `${farmName}/${sensor[1]}/${nodeName}`;

// env variable for debug
process.env.MQTT_WRITE_70_FALSE = `${farmName}/${debug[0]}/${nodeName}`;
process.env.MQTT_70_STATE = `${farmName}/${debug[1]}/${nodeName}`;
...
module.exports = {
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "$2b$08$c/VJ0hkZ38hcOs.7y6tkSuQ6PK1lDEHtiCIrCucORsmhljMIL/ck2",
            permissions: "*"
        }]
    },
    ...
    //// https object:
    https: {
      key: require("fs").readFileSync('/home/azureuser/node-red/node-red-2000/ssl_key/key.pem'),
      cert: require("fs").readFileSync('/home/azureuser/node-red/node-red-2000/ssl_key/cert.pem')
    },
    ////https function:
    // https: function() {
